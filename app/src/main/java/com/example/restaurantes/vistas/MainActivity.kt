...
import com.example.restaurantes.adapters.Adapter
...
class MainActivity : AppCompatActivity(), OnItemListener {
    ...
    public fun search (){
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val call: Response<Restaurante> = getRetrofit().create(APIService::class.java).getRestaurant("listarestaurantes")
